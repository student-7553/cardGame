...
public class DragAndDrop : MonoBehaviour
{
    ...
    private void MousePressed(InputAction.CallbackContext context)
    {
        ...
        if (Physics.Raycast(ray, out hit))
        {
            if (hit.collider != null && hit.collider.gameObject.CompareTag("interactable"))
            {
                ...
                Vector3 differenceIn2dSpace = new Vector3(mousePositionInWorld.x - clickedObject.transform.position.x, 0, mousePositionInWorld.z - clickedObject.transform.position.z);
    ...
    private IEnumerator DragUpdate(GameObject clickedObject, Vector3 differenceIn2dSpace)
    {
        ...
        while (mouseClick.ReadValue<float>() != 0)
        {
            ...
            movingToPoint  =movingToPoint + differenceIn2dSpace;
