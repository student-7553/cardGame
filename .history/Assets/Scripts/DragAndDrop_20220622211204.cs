...
public class DragAndDrop : MonoBehaviour
{
    ...
    private void MousePressed(InputAction.CallbackContext context)
    {
        ...
        {
            Debug.Log(hit.collider.gameObject.CompareTag("clickedObject") ,hit.collider.gameObject.tag )
            if (hit.collider != null && hit.collider.gameObject.CompareTag("clickedObject"))
            {
