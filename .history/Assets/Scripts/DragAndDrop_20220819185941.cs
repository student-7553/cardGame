...
public class DragAndDrop : MonoBehaviour
{
    ...
    private IEnumerator DragUpdate(Card hitCard)
    {
        ...
        Vector3 clickedDifferenceInWorld = new Vector3(hitCard.cardGameObject.transform.position.x - mousePositionInWorld.x, 0, hitCard.cardGameObject.transform.position.z - mousePositionInWorld.z);
