...
public class DragAndDrop : MonoBehaviour
{
    ...
    private IEnumerator DragUpdate(Card hitCard, Vector3 clickedDifferenceInWorld)
    {
        ...
        hitCard.cardGameObject.transform.position = new Vector3(hitCard.cardGameObject.transform.position.x, hitCard.cardGameObject.transform.position.y - 1, clickedObject.transform.position.z);
    }
