...
public class DragAndDrop : MonoBehaviour
{
    ...
    private void DragFinishHandler(GameObject clickedObject)
    {
        ...
        Vector3 leftTopCornerPoint = new Vector3(clickedObject.transform.position.x - (clickedObject.transform.localScale.x/2) ,clickedObject.transform.position.y,clickedObject.transform.position.y - (clickedObject.transform.localScale.x/2));
