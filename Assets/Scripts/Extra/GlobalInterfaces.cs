...
namespace Core
{
	...
	{
		public static BaseNodeStats base1Stats = new BaseNodeStats(10, 10, 1, 1, 10000);
		public static BaseNodeStats base2Stats = new BaseNodeStats(10, 15, 1, 1, 45);
		public static BaseNodeStats base3Stats = new BaseNodeStats(10, 20, 1, 1, 45);
